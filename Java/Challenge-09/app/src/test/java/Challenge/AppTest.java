...
class AppTest {
    ...
    @Test
    void PseudoQueueTestEnqueue(){
        PseudoQueue pseudoQueue = new PseudoQueue();
        pseudoQueue.enqueue(10); // first In first out
        pseudoQueue.enqueue(15);
        pseudoQueue.enqueue(20);
        String result = pseudoQueue.toString();
        assertEquals("[10, 15, 20]",result);
    }
    @Test
    void PseudoQueueTestDequeue(){
        PseudoQueue pseudoQueue = new PseudoQueue();
        pseudoQueue.enqueue(10); // first In first out
        pseudoQueue.enqueue(15);
        pseudoQueue.enqueue(20);
